...
export default class Home extends React.Component {
    ...
    getOrder = async () => {
        ...
        console.log(token)
        fetch('https://maharaj-3.herokuapp.com/api/v1/maharajReq/myreq',
            {
                method: 'GET',
                headers: {
                    "Authorization": token,
        ...
        return (
            <View style={style.container}>
                <View style={{ flexDirection: 'row', backgroundColor: '#000', }}>
                    <Text style={{ fontSize: 18, color: '#fff', fontWeight: 'bold', marginLeft: 10, marginVertical: 10, borderBottomWidth: 1, marginTop: 10 }}>Accepted Orders</Text>
                </View>
                {
